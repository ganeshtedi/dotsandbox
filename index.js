...
function boxdot(n){
	...
	for(var j=0; j<m; j++){
		for(var i=0; i<n; i++){
			...
			html += `
				<div class="box" data-id="${c}" style=" left:${x+2.5}px; top:${y+2.5}px"></div>
				<div class="dot" style="left:${x-5}px; top:${y-5}px" data-box="${c}"></div>						
				<div class="line lineh" data-line-1="${c}" data-line-2="${c-m}" style=" left:${x}px; top:${y}px" data-active="false"></div>
...
function reset(){
	document.getElementById("app").innerHTML.style.visibility=false;
	document.getElementById('box3').style.visibility = 'visible';   
    document.getElementById('box4').style.visibility = 'visible';
}